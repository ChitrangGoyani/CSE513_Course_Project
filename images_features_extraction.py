...
def main(datasets, encoder, proprecess, annotations, outpath):
    results = []
    if datasets == 'coco' or datasets == 'flickr30k' or datasets == 'flickr8k': # coco, flickr30k
        ...
        elif datasets == 'flickr8k':
            rootpath = './annotations/flickr8k/Images/'
...
if __name__ == '__main__':
    ...
    path_val_flickr8k = './annotations/flickr8k/val_captions.json'
    path_test_flickr8k = './annotations/flickr8k/test_captions.json'
    ...
    outpath_test_flickr8k = f'./annotations/flickr8k/test_captions_{clip_name}.pickle'
    outpath_val_flickr8k = f'./annotations/flickr8k/val_captions_{clip_name}.pickle'
    ...
    with open(path_val_flickr8k, 'r') as infile:
        val_flickr8k = json.load(infile)
    with open(path_test_flickr8k, 'r') as infile:
        test_flickr8k = json.load(infile)
    ...
    if not os.path.exists(outpath_val_flickr8k):
        main('flickr8k', encoder, proprecess, val_flickr8k, outpath_val_flickr8k)

    if not os.path.exists(outpath_test_flickr8k):
        main('flickr8k', encoder, proprecess, test_flickr8k, outpath_test_flickr8k)

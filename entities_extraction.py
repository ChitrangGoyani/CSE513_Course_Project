...
if __name__ == '__main__':
    datasets = ['coco_captions', 'flickr30k_captions','flickr8k_captions']
    
    captions_path = [
        './annotations/coco/train_captions.json',
        './annotations/flickr30k/train_captions.json',
        './annotations/flickr8k/train_captions.json'
    ]
    
    out_path = [
        './annotations/coco/coco_with_entities.pickle',
        './annotations/flickr30k/flickr30k_with_entities.pickle',
        './annotations/flickr8k/flickr8k_with_entities.pickle'
    ]
    
    print(out_path[2])
    idx = 2 # only need to change here! 0 -> coco training data, 1 -> flickr30k training data
